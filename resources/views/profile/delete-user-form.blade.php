        ...
        <x-dialog-modal wire:model.live="confirmingUserDeletion">
            ...
            <x-slot name="content">
                ...
                <div class="mt-4" x-data="{}" x-on:confirming-delete-user.window="setTimeout(() => $refs.password.focus(), 250)">
                    <x-input id="deleteUser" name="deleteUser" type="password" class="form-input mt-1 block w-3/4"
            ...
            <x-slot name="footer">
                ...
                <x-button variant="danger" class="ml-3" wire:click="deleteUser" wire:loading.attr="disabled">
                    {{ __('Delete Account') }}
                </x-button>
            </x-slot>
        </x-dialog-modal>
