...
namespace App\Themes\PowerGridThemes;
...
class Sirus extends Tailwind
{
    ...
    public function checkbox(): Checkbox
    {
        return Theme::checkbox()
            ...
            ->input('h-4 w-4 form-checkbox text-purple-500 border-gray-300 rounded focus:border-purple-300 focus:ring focus:ring-purple-500 dark:border-gray-600 dark:bg-dark-eval-1 dark:focus:ring-offset-dark-eval-1');
    }
